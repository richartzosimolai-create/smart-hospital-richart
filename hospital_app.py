...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#6769a4 0%,#2d2e58 60%,#39407c 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#6769a4 0%;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#eef1f5;">What are your main symptoms?</span>
    ...
    with c3:
        ...
        shortness_breath = st.checkbox("😮‍💨  Shortness bof breath")
    with c4:
    ...
    <div style="background:#6769a4 0%;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#f7f7f7;">How long have you had these symtomps?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="background:#6769a4 0%;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#edeeee;">How would you rate the severity?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="background:#6769a4;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#f4f5f8;">Do you have any of the following</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with res_col:
        ...
        <div style="background:{info['bg']};border:1.5px solid {info['border']};
            ...
            <div style="margin-top:20px;padding:12px 16px;background:rgba(0,0,0,0.05);
                ...
                ⚠️ This is ab AI suggestion, not a medical diagnosis. please consult a doctor for further evaluation.
            </div>
        </div>
        """, unsafe_allow_html=True)
